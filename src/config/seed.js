...
// connect to mongo db
const mongoUri = process.env.MONGODB_URI || 'springs-api'
...
const seedDb = async () => {
  ...
  await Spring.insertMany(springData);
};
